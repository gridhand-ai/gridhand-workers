...
async function call({ modelString, clientApiKeys, systemPrompt, messages, maxTokens = 150 }) {
    ...
    if (provider === 'anthropic') {
        return callAnthropic(modelId, apiKey, systemPrompt, messages, maxTokens);
    } else if (providerConfig.openaiCompat) {
        return callOpenAICompat(modelId, apiKey, baseUrl, systemPrompt, messages, maxTokens, providerConfig.noAuth);
    }
